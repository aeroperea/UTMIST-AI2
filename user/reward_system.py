...
def gen_reward_manager(log_terms: bool=True):
    reward_functions = {
        ...
        'holding_more_than_3_keys': RewTerm(func=holding_nokeys_or_more_than_3keys_penalty, weight=21.0),
        'taunt_reward': RewTerm(func=in_state_reward, weight=-5.5, params={'desired_state': TauntState}),
